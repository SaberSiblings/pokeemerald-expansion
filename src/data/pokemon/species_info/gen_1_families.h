...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_PIDGEOTTO] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_FLYING, TYPE_BEAST),
        .catchRate = 120,
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .baseAttack    = 65,
        .baseDefense   = 75,
        .baseSpeed     = 116, //P_UPDATED_STATS >= GEN_6 ? 101 : 91,
        .baseSpAttack  = 111,
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_FLYING, TYPE_BEAST),
        .catchRate = 45,
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_CROBAT/*, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})*/}),
    #endif
    },
    ...
    [SPECIES_VILEPLUME] =
    {
        ...
        .baseDefense   = 85,
        .baseSpeed     = 65,
        .baseSpAttack  = 130, //P_UPDATED_STATS >= GEN_6 ? 110 : 100,
    ...
    [SPECIES_ABRA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_KADABRA}),
    },
