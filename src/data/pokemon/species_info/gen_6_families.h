...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RIVALRY, ABILITY_OBLIVIOUS, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RIVALRY, ABILITY_QUEENLY_MAJESTY, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .abilities = { ABILITY_FRISK, ABILITY_INFILTRATOR, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_PURPLE,
