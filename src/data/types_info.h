...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar  Beast   Sound
    ...
    [TYPE_SOUND]    = {______, ______, ______, ______, ______, ______, ______, X(0.5), X(0.5), ______, ______, ______, X(0.5), ______, ______, X(2.0), ______, ______, X(0.5), X(2.0), ______, ______, X(2.0)},
};
